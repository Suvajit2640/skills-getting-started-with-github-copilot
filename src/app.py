...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["aaron@mergington.edu", "maria@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Team basketball training and interschool games",
    ...
    "Science Club": {
        "description": "Explore experiments and scientific concepts in hands-on sessions",
